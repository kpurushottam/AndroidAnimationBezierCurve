...
/**
 * Created by craterzone3 on 7/4/16.
 */
public class BazierCurv  extends Animation{
...
// http://www.math.ubc.ca/~cass/gfx/bezier.html
     ...
     */
         ...
         */
        public BazierCurv(float fromXDelta, float toXDelta,
         ...
         *                   ABSOLUTE, or a percentage (where 1.0 is 100%) otherwise.
         */
        public BazierCurv(int fromXType, float fromXValue, int toXType,
